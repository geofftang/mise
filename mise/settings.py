"""
Django settings for mise project.
...
SECRET_KEY = '&5e-rt%765)$2%y+!5vd)(--!&job%g3%ntrdvdg-wqna2l%k-'
...
ROOT_URLCONF = 'mise.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'cookbook/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
